...
5. `docs/AI_INVESTMENT_RESEARCH_REFERENCES.md`
6. `docs/MULTI_TOOL_HANDOFF.md`
7. `docs/OPERATOR_RUNBOOK.md`
8. `docs/ECOREPORT_DAILY_AUTOMATION.md`
...
- `README.md`
- `docs/STAGE_NAMES.md`
- `docs/AI_INVESTMENT_RESEARCH_REFERENCES.md`
